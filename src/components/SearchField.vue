...
export default {
  ...
  /*
   * The reason to why I didnt use the v-if on the component itself in CardToolbar.vue
   * is because the transition component needs to wrap around a v-if to work.
   * Addtionally I can seperate the logic for the search function to this component.
   */

const releaseBerryStandardSettings = {
  showTitle: true,
  timerFormat: 'dd:hh:ss'
}

const releaseBerryStandardPresets = [
  {
...
const releaseBerryMinimalSettings = {
  showTitle: false,
  showBackdrop: false,
  timerFormat: 'dd:hh:ss'
}

const releaseBerryMinimalPresets = [
  {
...
export {
  ...
  releaseBerryMinimalPresets,
  releaseBerryMinimalSettings
}
